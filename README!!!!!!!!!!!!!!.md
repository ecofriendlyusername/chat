...
<br>
subscribe to channels를 클릭합니다<br>
(클릭시 메인채널과 유저가 속한 채팅방들의 채팅방들을 가져옵니다.)<br>
메인채널은 채팅방 초대 등에만 쓰이는 채널(?) 이라고 보시면 됩니다. <br>메인채널, 채팅방들 모두 destination이 있어요<br>
테스트해보실 브라우저 두쪽 다(이메일 다른거 쓰세요) 클릭하시고 나면 다음 단계로 넘어가세요
<br>
<br>
<br>
...
저는 프론트가 아니니까 대충 하드코딩 해서 이메일 두개만 넣을 수 있게 만들어쓴데 프론트쪽에서 이메일 여러개 넣을 수 있게 만드시면 되겠죠<br>
...
<img width="460" alt="image" src="https://github.com/ecofriendlyusername/chat/assets/46067895/7dfcec48-d52f-421a-acd8-05f2e41e9049">
&nbsp;

누른 후 양쪽 브라우저가 정상적으로 채팅 가능하면 정상입니다.
